                        ...
                        <form action="./index.php" method="post">
                            <section class="form-group row mb-2">
                                ...
                                <section class="col-md-6">
                                    <input type="text" name="user" id="user" class="form-control" value="<%=request.getParameter("usuario")%>" disabled>
                                </section>
                            </section>
                            <section class="form-group row mb-2">
                                <label for="phone_number" class="col-md-4 col-form-label text-md-right">Contraseña:</label>
                                <section class="col-md-6">
                                    <input type="password" id="pass" name="pass" class="form-control" value="<%=request.getParameter("password")%>" disabled>
                                </section>
                        </form>
                    </section>
                </section>
